...
using static GivingActually.Models.HelperModels.Helper;
using Authorization = GivingActually.Models.HelperModels.Authorization;
using ViewType = GivingActually.Models.HelperModels.Helper.ViewType;
